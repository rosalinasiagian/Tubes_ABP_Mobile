...
class EditTaskSheet {
                      ...
                      GestureDetector(
                        onTap: () {
                          _showCategorySelector(context, selectedCategoryId,
                              categories, onCategoriesUpdated, (val) {
                                      ...
                                      if (emptyFields.isNotEmpty) {
                                        showDialog(
                                          ...
                                          builder: (dialogCtx) => AlertDialog(
                                            ...
                                            content: Text(
                                                'Anda belum mengisi: ${emptyFields.join(" & ")}',
                                                style: GoogleFonts.montserrat(
                                                    color: t.textSecondary,
                                                    fontSize: 13)),
                                            actions: [
  ...
  static void _showCategorySelector(
      BuildContext context,
      int? currentCategoryId,
      List<dynamic> categories,
      Future<void> Function() onCategoriesUpdated,
