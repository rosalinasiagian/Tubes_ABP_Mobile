...
class _PriorityScreenState extends State<PriorityScreen> {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: Colors.black
                            .withValues(alpha: t.isDark ? 0.3 : 0.02),
                        blurRadius: 15,
                  ...
                  child: _isLoading
                      ...
                      : Column(
                          ...
                          children: [
                            ...
                            Text(
                              '$totalActive task aktif di semua prioritas',
                              style: GoogleFonts.montserrat(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: dotColor.withValues(alpha: 0.15)),
                    ),
                    child: Text(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isExpanded ? dotColor.withValues(alpha: 0.5) : t.border,
  ...
  Widget _buildEmptyStateBox(TemaData t, Color dotColor, String emptyText) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: t.textSecondary.withValues(alpha: t.isDark ? 0.2 : 0.15),
          width: 1,
        ),
      ),
      child: Center(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Gagal menyelesaikan task')));
      }
    }
  }
  ...
  Future<void> _deleteTask(Map<String, dynamic> task) async {
    final bool confirm = await showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            title: Text('Hapus Task',
                style: GoogleFonts.montserrat(
                    fontWeight: FontWeight.bold,
                    color: TemaData().textPrimary)),
            content: Text('Apakah Anda yakin ingin menghapus task ini?',
                style: GoogleFonts.montserrat(color: TemaData().textSecondary)),
            actions: [
              TextButton(
                onPressed: () => Navigator.pop(ctx, false),
                child: Text('Batal',
                    style: GoogleFonts.montserrat(
                        color: TemaData().textSecondary)),
              ),
              ElevatedButton(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Gagal menghapus task')));
        setState(() => _isLoading = false);
      }
    }
  }

  void _showCategorySelector(BuildContext context, int? currentCategoryId,
      Function(int?) onSelected, TemaData t) {
  ...
  Widget _inputField(
      TextEditingController controller, String hint, IconData icon, TemaData t,
      {int maxLines = 1}) {
    return Container(
      decoration: BoxDecoration(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintText: hint,
          hintStyle:
              GoogleFonts.montserrat(fontSize: 13, color: t.textSecondary),
          prefixIcon: Column(
            mainAxisSize: MainAxisSize.min,
  ...
  void _showEditTaskSheet(BuildContext context, Map<String, dynamic> task) {
    ...
    String selectedPriority = priorityVal == 'high'
        ? 'Tinggi'
        : (priorityVal == 'low' ? 'Rendah' : 'Sedang');

    int? selectedCategoryId = task['category_id'] != null
        ? int.tryParse(task['category_id'].toString())
        : null;
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          _showCategorySelector(context, selectedCategoryId,
                              (val) {
                      ...
                      const SizedBox(height: 12),
                      _inputField(descriptionController, 'Deskripsi task...',
                          Icons.description, t,
                          maxLines: 3),
                      const SizedBox(height: 12),
                      GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(p,
                                  style: GoogleFonts.montserrat(
                                      ...
                                      fontWeight: FontWeight.w600,
                                      color:
                                          isActive ? color : t.textSecondary)),
                            ),
                          );
                        }).toList(),
                      ),
